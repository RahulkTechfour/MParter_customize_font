...
public class KnowMoreCardProvider extends LuminousCardProvider {

    @Override
    protected void onCreated() {
        super.onCreated();
        setLayout(R.layout.card_know_more);
    }
    ...
    public void render(@NonNull final View view, @NonNull final Card card) {
        ...
        final TextView tvMore = (TextView) findViewById(view, R.id.tv_more, TextView.class);
        if (!TextUtils.isEmpty(homeCardEntity.getAction1Text())) {
            tvMore.setText(homeCardEntity.getAction1Text());
        }
        if (!TextUtils.isEmpty(homeCardEntity.getAction1Color())) {
            tvMore.setTextColor(Color.parseColor(homeCardEntity.getAction1Color()));
        }
        ...
        final RelativeLayout llHeader = (RelativeLayout) findViewById(view, R.id.ll_background, RelativeLayout.class);
