...
public class HomeData {
    ...
    @SerializedName("connectplus_data")
    @Expose
    private List<HomeCardEntity> connectplus_data = null;
    ...
    public List<HomeCardEntity> getConnectplus_data() {
        return connectplus_data;
    }

    public void setConnectplus_data(List<HomeCardEntity> connectplus_data) {
        this.connectplus_data = connectplus_data;
    }
}
