...
public class OneImageCardProvider extends LuminousCardProvider {

    @Override
    protected void onCreated() {
        super.onCreated();
        setLayout(R.layout.card_one_image);
    }
    ...
    public void render(@NonNull final View view, @NonNull final Card card) {
        ...
        //Image
        final ImageView mainImage = (ImageView) findViewById(view, R.id.main_image, ImageView.class);
            ...
            Glide.with(getContext())
                    ...
                    .into(new SimpleTarget<Bitmap>() {
                        ...
                        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                            mainImage.setImageDrawable(new BitmapDrawable(getContext().getResources(), resource));
                        }
                    });


        } else
            mainImage.setBackgroundResource(HomeCardUtils.getResourceId(getContext(), homeCardEntity.getBackgroundImage()));
