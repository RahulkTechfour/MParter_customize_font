package com.luminous.cardslibrary.view;
...
import com.luminous.cardslibrary.card.CardLayout;
...
public class MaterialRecycleAdapter extends RecyclerView.Adapter<MaterialRecycleAdapter.ViewHolder>
        implements Observer {
    ...
    public MaterialRecycleAdapter(@NonNull final MaterialRecyclerView.OnSwipeAnimation swipeAnimation,
